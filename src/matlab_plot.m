...
plotHandle = plot(axesHandle,time,temperature,'Marker','.','LineWidth',1,'Color',[0 1 0]);
...
% Create ylabel
ylabel('Temperature in Celsius','FontWeight','bold','FontSize',14,'Color',[1 1 0]);
